...
*/
        ...
        /*ITERATORS*/
        	iterator begin( void ) { return iterator(this->_nil->right->tree_min()); }

			const_iterator begin( void ) const { return const_iterator(this->_nil->right->tree_min()); }

			iterator end( void ) { return iterator(this->_nil); }

			const_iterator end( void ) const { return const_iterator(this->_nil); }

			reverse_iterator rbegin( void ) { return reverse_iterator(this->_nil()); }

			const_reverse_iterator rbegin( void ) const { return const_reverse_iterator(this->_nil()); }
